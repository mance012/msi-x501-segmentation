...
dir = "/projects/standard/msistaff/mance012/projects/image-proc-workshop/advanced/Fluo-C3DL-MDA231/01";
...
for (i = 0; i < titles.length; i++) {
    if (titles[i].contains("Cellpose-SAM")) {
        ...
        saveAs("Tiff", "/projects/standard/msistaff/mance012/projects/image-proc-workshop/advanced/all_times.tif_Cellpose-SAM.tif");
        break;
    }
}
#+end_src
